            ...
            "lessons": [
                {
                    ...
                    "exercises": [
                        theory(
                            ...
                            "Ты не сидишь за ним лично — ты подключаешься к нему удалённо, через "
                            "интернет, и после подключения управляешь им так, будто сидишь прямо за "
                            "этим компьютером.",
                            example="$ ssh engineer@acme-server-01\nWelcome to Acme Cloud",
                            skill_tags=["basics.server"],
                        ),
                        theory(
                            "После подключения ты попадаешь в терминал — текстовый интерфейс, куда "
                            "вводишь команды вместо кликов мышкой. Ни рабочего стола, ни окон — только "
                            "текст.\n\n"
