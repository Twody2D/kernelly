            ...
            "lessons": [
                {
                    ...
                    "exercises": [
                        theory(
                            ...
                            "куда вводишь команды вместо кликов мышкой. Команда `whoami` показывает, "
                            "под каким пользователем ты сейчас работаешь.",
                            example="$ whoami\nengineer",
                ...
                },
                {
                    ...
                    "exercises": [
                        theory(
                            "Каждая команда выполняется в какой-то папке (директории). `pwd` "
                            "(Print Working Directory) показывает, где ты сейчас находишься. `ls` "
                            "показывает, что лежит в этой папке.",
                            example="$ pwd\n/home/engineer\n$ ls\napp  config  logs",
                            skill_tags=["linux.basics"],
                        ),
                        terminal(
                ...
                },
                {
                    ...
                    "exercises": [
                        theory(
                            ...
                            "куда программа записывает всё, что происходило. Команда `tail` "
                            "показывает последние строки файла — то есть самые свежие записи.",
            ...
            "lessons": [
                {
                    ...
                    "exercises": [
                        theory(
                            "Чтобы попасть в другую папку, используется `cd` (change directory) с "
                            "указанием пути. Например, `cd /var/log` переносит тебя в папку с логами.",
                            example="$ cd /var/log\n$ pwd\n/var/log",
                            skill_tags=["linux.basics"],
                        ),
                        terminal(
                ...
                },
                {
                    ...
                    "exercises": [
                        theory(
                            "Если не знаешь, где лежит файл — используй `find`. А чтобы увидеть "
                            "вообще все файлы в папке, включая скрытые (начинающиеся с точки), у "
                            "`ls` есть флаги `-l` (подробно) и `-a` (все файлы).",
                ...
                },
                {
                    ...
                    "exercises": [
                        theory(
                            ...
                            "и запускать файл. `chmod` меняет эти права. Например, `chmod +x` делает "
                            "файл исполняемым — без этого скрипт просто откажется запускаться.",
                ...
                },
                {
                    ...
                    "exercises": [
                        theory(
                            "Каждая программа на сервере — это процесс. `ps aux` показывает все "
                            "запущенные процессы. А сервисами (например, nginx) управляет "
                            "`systemctl` — им можно запускать, останавливать и перезапускать программы.",
                ...
                },
                {
                    ...
                    "exercises": [
                        theory(
                            "journalctl показывает системный журнал — логи всех служб, управляемых "
                            "systemd. А `grep` ищет нужный текст внутри файла, например конкретную "
                            "ошибку среди тысяч строк.",
